...
def conv2x2(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1):
    """2x2 convolution with padding"""
    return nn.Sequential(
        nn.ZeroPad2d((0, dilation, 0, dilation)),
        nn.Conv2d(
            in_planes,
            out_planes,
            kernel_size=2,
...
class ResNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.resnet = makeResNet(BasicBlock, [2, 2, 3, 4])
