...
def load_dataset(type, path, spilt_rate, fft_size=512, hop_size=256, input_type=2):
...
if __name__ == '__main__':
    ...
    # arg = Args("dpcrn_se", model_name="dpcrn_se20240515_235913")
    arg = Args("dpcrn_se")
    arg.epochs = 35
    arg.batch_size = 16
    arg.save = True
    ...
    model = load_pretrained_model(
        r"D:\work\speechEnhancement\speechQuality\QualityNetPOLQA\models\dpcrn_se20240515_235913\final.pt")
    ...
    trainer.test(test_dataset=test_dataset, model=model, q_len=500)
