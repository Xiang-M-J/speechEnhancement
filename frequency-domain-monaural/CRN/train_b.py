...
train_loader = VoiceBankDemandBatch(" ", train_noisy_path, train_clean_path, batch_size=2, files=train_files)
valid_loader = VoiceBankDemandBatch(" ", train_noisy_path, train_clean_path, batch_size=2, files=valid_files)
...
np.save("loss_b.npy", {"train_loss": train_losses, "valid_loss": valid_losses})
