...
from utils import VoiceBankDemandBatch
...
temp_dataset = VoiceBankDemandBatch(train_scp_path, train_noisy_path, train_clean_path, shuffle=True)
test_loader = VoiceBankDemandBatch(test_scp_path, test_noisy_path, test_clean_path, shuffle=True)

train_files, valid_files = temp_dataset.train_valid_spilt([0.8, 0.2])
train_loader = VoiceBankDemandBatch(" ", train_noisy_path, train_clean_path,
                                    batch_size=batch_size, files=train_files, shuffle=True)
valid_loader = VoiceBankDemandBatch(" ", train_noisy_path, train_clean_path,
