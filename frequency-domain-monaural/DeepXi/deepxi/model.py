...
class DeepXi():
    ...
    def train(
        ...
        if loss_fnc == "BinaryCrossentropy":
            loss = BinaryCrossentropy()
        elif loss_fnc == "MeanSquaredError":
    ...
    def mbatch_gen(self, n_epochs):
        ...
        for _ in range(n_epochs):
            ...
            for _ in range(self.n_iter):
                ...
                start_idx += self.mbatch_size;
                end_idx += self.mbatch_size
