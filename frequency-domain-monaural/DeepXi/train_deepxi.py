...
if __name__ == '__main__':
    ...
    args.test_x_path = os.path.join('/media/luoxiaoxue/LXX2/denoise_review/speech_enhancement_overview/datasets/mix',
                                    test_choice)
    args.test_s_path = '/media/luoxiaoxue/LXX2/denoise_review/speech_enhancement_overview/datasets/mix'
    args.out_path = os.path.join(
        '/media/luoxiaoxue/LXX2/denoise_review/speech_enhancement_overview/DeepXi_dll/out/y/WSJ/', test_choice)
